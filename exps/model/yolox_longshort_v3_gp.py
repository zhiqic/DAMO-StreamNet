...
class YOLOXLONGSHORTV3GP(nn.Module):
    """
    ...
    def __init__(
        ...
        if context_pool_cfg is None:
            context_pool_cfg = dict(
                                    feat_channels=(128, 256, 512),
                                    context_channels=(128, 256, 512),
                                    fusion_mode="concat",
                                    with_project=False,
                                )
        self.context_pool = ContextPool(**context_pool_cfg)
    ...
    def forward(self, x, targets=None, buffer=None, mode='off_pipe'):
        ...
        if mode == 'off_pipe':
            ...
            if self.training:
                ...
                fpn_outs = self.context_pool(fpn_outs)
