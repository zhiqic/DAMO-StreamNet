...
class DFPPAFPNSHORTCP(nn.Module):
    """
    ...
    def off_forward(self, inputs):
        ...
        rurrent_pan_out2, rurrent_pan_out1, rurrent_pan_out0 = inputs[0]
        ...
        for i in range(self.frame_num - 1):
            ...
            support_pan_out2, support_pan_out1, support_pan_out0 = inputs[i+1]
