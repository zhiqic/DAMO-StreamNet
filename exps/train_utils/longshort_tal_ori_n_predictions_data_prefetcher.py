...
class DataPrefetcher:
    ...
    def preload(self):
        ...
        with torch.cuda.stream(self.stream):
            ...
            self.next_target = (self.next_target[0].cuda(non_blocking=True), self.next_target[1].cuda(non_blocking=True), self.next_target[2].cuda(non_blocking=True))
    ...
    def next(self):
        ...
        self.preload()
        return (short_input, long_input), (target[0], target[1], target[2])
        # return input, target
