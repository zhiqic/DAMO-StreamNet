...
from .longshort_tal_ori_n_predictions_data_prefetcher import DataPrefetcher
...
class Trainer:
    ...
    def train_one_iter(self):
        ...
        targets = (targets[0].to(self.data_type), targets[1].to(self.data_type), targets[2].to(self.data_type))
        targets[0].requires_grad = False
        targets[1].requires_grad = False
        targets[2].requires_grad = False
